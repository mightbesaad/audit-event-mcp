...
// 30 min assumes an instant channel is connected. Per-channel defaults (4h email-only) land with
// the channel ladder (D4); gvnr's 600s default was calibrated for a watching human — not ported.
